...
# import uuid
# import os
# from camera import hand_tracking
#
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_LEFT:
                        ...
                        if self.car_x_coordinate < 440:
                            self.car_x_coordinate += 50
                    elif event.key == pygame.K_q:  # Check for 'q' key
                        self.crashed = True  # Set crashed to True to exit the game
...
def racing_main():
    ...
    # try:
    #     # Keep the main thread running while threads are active
    #     while hand_tracking_thread.is_alive():
    #         sleep(1)
